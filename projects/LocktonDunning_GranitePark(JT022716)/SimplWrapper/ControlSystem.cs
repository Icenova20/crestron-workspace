 ...
 * Panel:  TSW-1070 (IPID 0x07) + XPanel (IPID 0x04)
 * 
    ...
    public class ControlSystem : CrestronControlSystem
    {
        ...
        public override void InitializeSystem()
        {
            try
            {
                ...
                _roomLogic.SetConfig("10.10.10.21"); // Lockton Production NVX IP
                _roomLogic.Initialize();
                ...
                xpanelLogic.SetConfig("10.10.10.21");
                xpanelLogic.Initialize();
